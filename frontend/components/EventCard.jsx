...
const EventCard = ({ event, onAction, actionLabel, actionDisabled, isAdmin }) => {
            ...
            <div className="p-6 flex-1 flex flex-col">
                ...
                {onAction && (
                    <button
                        ...
                        className={`w-full py-2.5 px-4 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${actionDisabled
